...
<p>7 Day</p>
{/*<span className={`flex gap-1 ${coin.market_data.price_change_percentage_24h < 0 ? 'text-red-400' : 'text-green-400'}`}>
          {coin.market_data.price_change_percentage_24h < 0 ?  <FiArrowDown className='icon' /> : <FiArrowUpRight className='icon' />}
